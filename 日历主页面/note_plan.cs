...
namespace 日历
{
    public partial class note_plan : Form
    {
        ...
        public void start_note_plan_all_wing()
        {
            ...
            explain_today_wing.Text = "当前为" + Form1.user_choose.year.ToString() + "年" + Form1.user_choose.month.ToString() + "月" + Form1.user_choose.day.ToString() + "日";
        ...
        public void create_note_plan()
        {
            ...
            filename_note = @"D:\calendar\note\"+Form1.user_choose.year.ToString() + Form1.user_choose.month.ToString() + Form1.user_choose.day.ToString()+@"note";
            ...
            filename_plan= @"D:\calendar\plan\"+Form1.user_choose.year.ToString() + Form1.user_choose.month.ToString() + Form1.user_choose.day.ToString() + @"plan";
        ...
        private void note_plan_Load(object sender, EventArgs e)
        {
