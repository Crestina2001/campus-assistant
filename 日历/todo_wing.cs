...
namespace 日历
{
    public partial class todo_wing : Form
    {
        ...
        {
            tree_show_wing tree_show_wing = new tree_show_wing();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Form1.tick_time_wing = 0;
        }
        public void t_tick(object sender, EventArgs e)
        {
            Form1.tick_time_wing++;
            label1.Text=(24-(Form1.tick_time_wing /60)).ToString()+":"+(60- Form1.tick_time_wing%60).ToString();
            if(Form1.tick_time_wing==25*60)//计时到了
            {
                t_wing.Enabled = false;
